...
import StateRecordIcon from "../../shared/components/StateRecordIcon";
...
export function TimeCellContents (props:TimeCellContentsProps){
    ...
    return (
        <>
            { run.urls.length ? 
                <span className="me-2 fw-bolder"><a href={run.urls[0]} target="_blank"><FontAwesomeIcon className="video-links" icon={faSquareYoutube} size="sm"/></a></span> : <></> }

...
export default function Leaderboard() {
    ...
    return (
        <div className="p-4 bg-white rounded shadow-sm d-flex flex-column align-items-center justify-content-start" key={"leaderboard"}>
                ...
                {mostGames && teamNamesData && mostGames.map((game) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="badge rounded-pill bg-secondary flex-shrink-0">{game.gameCount}</div>
                        </div>
                    );
                })}
